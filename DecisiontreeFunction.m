            ...
            if kc==0
                ...
                if fc==0
                    ...
                    for j=1:nfset
                        ...
                        [Disp(5,1),Disp(5,3)]=XuTranslationalFun( E,s1,s1,s1,s2,F );
                        [Disp(5,2),Disp(5,4)]=XuTranslationalFun( E,s1,s2,s1,s2,F );
        ...
        if romc==0
            ...
            if kc==0
                ...
                if fc==0
                    ...
                    %Joint 3
                    [Disp(3,1),Disp(3,3)] = LobontiuSymmetricCircularFun(E,s1,s1,s2,F);%maxK
                    ...
                    %Joint 5
                    [Disp(5,1),Disp(5,3)] = RotationallySymmetricLeafHingeFun(E,s1,s1,F);%maxK
            ...
            if kc==0
                ...
                if fc==0
                    ...
                    for j=1:nfset
                        ...
                        for i=n:-1:1
                            name=names{Disp(i,5)};
                            fprintf('%s with %2.4f degrees displacement. \n',name,Disp(i,2))
                        end
                    end
                    %-----------------------------------------------------%
                    %%END OF N,N,N TREE
